...
class MyTimePickerDialog extends StatefulWidget {
  ...
  final ValueChanged<TimeOfDay>? handleTimeChanged;
...
class _MyTimePickerDialogState extends State<MyTimePickerDialog>
  ...
  void _handleTimeChanged(TimeOfDay value) {
    ...
    if (widget.handleTimeChanged != null) {
      widget.handleTimeChanged!(value);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final listFooterCase = [
      TimePickerEntryMode.dial,
      TimePickerEntryMode.input
    ];
    final showFooter = widget.cancelText != '' ||
        widget.confirmText != '' ||
        listFooterCase.contains(_entryMode.value);

    final Widget actions = !showFooter
        ? const SizedBox()
        : Row(
            children: <Widget>[
    ...
    final Size? dialogSize = showFooter ? _dialogSize(context) : null;
    return Dialog(
      shape: shape,
